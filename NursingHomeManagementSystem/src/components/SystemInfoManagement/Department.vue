    ...
    <el-container>
      <el-header class="header-row">
        ...
        <el-row type="flex" justify="start" :gutter="20">
          <el-col :span="8">
            <el-input clearable clearable v-model="queryName" placeholder="请输入部门名称"></el-input>
          </el-col>
          <el-col :span="8">
            <el-select clearable clearable class="widen" v-model="queryState" placeholder="请选择状态">
              <el-option v-for="item in stateOption" :key="item" :label="item" :value="item">
              </el-option>
            </el-select>
          </el-col>
